...
(julia -t 24 collect_junction.jl anilist_users user anilist_user_items items nothing nothing userid db_junction_last_changed_at "http://localhost:4003/anilist_user" 24 |& julia -t 1 logrotate.jl $logs/anilist_users.log) &
...
(julia -t 8 collect_junction.jl kitsu_users user kitsu_user_items items nothing nothing userid db_junction_last_changed_at "http://localhost:4003/kitsu_user" 9 |& julia -t 1 logrotate.jl $logs/kitsu_users.log) &
