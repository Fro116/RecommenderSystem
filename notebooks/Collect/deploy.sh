...
(julia -t 32 collect_junction.jl mal_users user mal_user_items items mal_userids userid username db_junction_last_changed_at "http://localhost:4003/mal_user" 93 |& julia -t 1 logrotate.jl $logs/mal_users.log) &
