...
(julia -t 16 collect_junction.jl animeplanet_users user animeplanet_user_items items animeplanet_userids userid username db_junction_last_changed_at "http://localhost:4003/animeplanet_user" 16 |& julia -t 1 logrotate.jl $logs/animeplanet_users.log) &
