...
(julia layer2.jl 4002 1 "http://localhost:4101/proxy,http://localhost:4102/proxy,http://localhost:4103/proxy,http://localhost:4104/proxy" true 10 "../../environment" |& julia -t 1 logrotate.jl $logs/layer2.log) &
(julia layer3.jl 4003 "http://localhost:4002" 1000 |& julia -t 1 logrotate.jl $logs/layer3.log) &
...
(julia collect_junction.jl mal_users user mal_user_items items mal_userids userid username db_junction_last_changed_at "http://localhost:4003/mal_user" 240 |& julia -t 1 logrotate.jl $logs/mal_users.log) &
...
(julia collect_junction.jl anilist_users user anilist_user_items items nothing nothing userid db_junction_last_changed_at "http://localhost:4003/anilist_user" 10 |& julia -t 1 logrotate.jl $logs/anilist_users.log) &
...
(julia collect_junction.jl animeplanet_users user animeplanet_user_items items animeplanet_userids userid username db_junction_last_changed_at "http://localhost:4003/animeplanet_user" 14 |& julia -t 1 logrotate.jl $logs/animeplanet_users.log) &
