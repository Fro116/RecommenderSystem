...
(cd /usr/src/app/layer2/notebooks/Collect && julia -t auto,auto --trace-compile trace layer2.jl 5002 10 "http://localhost:5001/proxy" true 10 "../../environment") &
(cd /usr/src/app/layer3/notebooks/Collect && julia -t auto,auto --trace-compile trace layer3.jl 5003 "http://localhost:5002" 1 1) &
(cd /usr/src/app/layer4/notebooks/Collect && julia -t auto,auto --trace-compile trace layer4.jl 5004 "http://localhost:5003" "../../environment/database/test_cases.csv") &
sleep 30
